...
from ckanext.schemingdcat.utils import (get_facets_dict, public_file_exists,
                                          public_dir_exists)
from ckanext.schemingdcat import config as sd_config
...
@helper
def schemingdcat_get_icon(choice, icons_dir=None):
...
def schemingdcat_listify_str(values):
    ...
    return values
@helper
def schemingdcat_load_yaml(file):
...
def schemingdcat_get_linked_data(id):
    ...
    """
    linkeddata_links = schemingdcat_load_yaml('linkeddata_links.yaml') if sd_config.debug else sd_config.linkeddata_links
...
def schemingdcat_get_geospatial_metadata():
    ...
    """
    geometadata_links = schemingdcat_load_yaml('geometadata_links.yaml') if sd_config.debug else sd_config.geometadata_links
