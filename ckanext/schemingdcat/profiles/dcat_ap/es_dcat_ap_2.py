...
class EsDCATAP2Profile(EuDCATAP2Profile):
    ...
    def parse_dataset(self, dataset_dict, dataset_ref):
        ...
        # call super method
        super(EsDCATAP2Profile, self).parse_dataset(dataset_dict, dataset_ref)
    ...
    def graph_from_dataset(self, dataset_dict, dataset_ref):
        ...
        # call super method
        super(EsDCATAP2Profile, self).graph_from_dataset(
    ...
    def graph_from_catalog(self, catalog_dict, catalog_ref):
        ...
        # call super method
        super(EsDCATAP2Profile, self).graph_from_catalog(
