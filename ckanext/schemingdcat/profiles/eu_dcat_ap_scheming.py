...
class EuDCATAPSchemingDCATProfile(SchemingDCATRDFProfile):
    ...
    Notes: 
        **EuropeanDCATAPSchemingProfile**: This is a compatibilty profile meant to add support for ckanext-scheming to the existing
    ...
    def parse_dataset(self, dataset_dict, dataset_ref):
        """
        Modify the dataset_dict generated by the eu_dcat_ap and eu_dcat_ap_2 profiles
